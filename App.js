...
export default class App extends Component {
    state = {
        ...
        countP: "",
        countV: "",
        image: 'https://as1.ftcdn.net/v2/jpg/01/33/30/14/1000_F_133301404_0Hy518K06tQf2XMRhE8RPOnl1nLjZmfQ.jpg', 
        ...
        if (this.state.count==6) {
          ...
          if (this.state.count==5) {
            this.setState({ 
                ...
                image: 'https://static.vecteezy.com/system/resources/thumbnails/004/435/915/small_2x/rating-stars-web-signs-5-stars-yellow-isolated-on-transparent-background-vector.jpg',
            })
          }
          if (this.state.count==4) {
            this.setState({ 
                message: 'you can do it you are almost there',
                image: 'https://t3.ftcdn.net/jpg/04/58/27/78/360_F_458277883_uuZbycdNAGCwAzfIf4kfvqBVzhYSf1ND.jpg',
            })
          }
          if (this.state.count==3) {
            this.setState({ 
                message: 'you can do it you are half way there',
                image: 'https://www.shutterstock.com/image-vector/rating-3-star-productreviewwebsite-apps-260nw-1359893363.jpg',
            })
          }
          if (this.state.count==2) {
            this.setState({ 
                message: 'you are getting there',
                image: 'https://png.pngtree.com/png-clipart/20230818/original/pngtree-two-2-star-rank-background-picture-image_8038876.png',
            })
          }
          if (this.state.count==1) {
            this.setState({ 
                message: 'you are getting there',
                image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/Star_rating_1_of_5.png/640px-Star_rating_1_of_5.png',
            })
          }
            ...
            <View style= {{display: this.state.enter}}>
              <View style={styles.contentContainer}>
                        ...
                        <Text style={styles.textFeed}>
                            Gayathri Kavitha and Ryan Goudjil
                        </Text>
              </View>
            </View>
